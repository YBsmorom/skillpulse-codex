...
以下截图由当前界面组件直接渲染，使用内置脱敏演示数据生成，不包含真实会话正文、浏览器地址栏、个人目录或本机日志。

![SkillPulse 总览](docs/assets/skillpulse-overview.png)

![SkillPulse Skill 库](docs/assets/skillpulse-library.png)

![SkillPulse 链路视图](docs/assets/skillpulse-chains.png)
