...
以下是公开安全版 demo 截图，用来展示 SkillPulse 的界面结构和视觉风格；示例数据经过脱敏，不对应任何真实本机会话。

![SkillPulse 总览](docs/assets/skillpulse-overview.svg)

![SkillPulse Skill 库](docs/assets/skillpulse-library.svg)

![SkillPulse 链路图](docs/assets/skillpulse-chain.svg)
